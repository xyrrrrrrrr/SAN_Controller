'''
This is the file to save the replay buffer.
...
def train(num_frames, DQN, multi_step=1):
    ...
    # save buffer(deque)
    with open('./buffer/buffer_{}_{}.pkl'.format(ENV_NAME, SEED), 'wb') as f:
